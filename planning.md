...
|------|-----------|----------------|
| **resident** | Own profile, voice journal, program aggregate data | Other residents' data, program director settings, faculty management |
| **faculty** | Resident directory, program data relevant to role | Voice journals, other faculty profiles (future) |
| **program_director** | Resident cohort data, faculty management, program settings | Voice journals (absolute privacy) |
| **super_admin** | Everything (with audit logging) | Nothing (audited) |
...
```typescript
// app/api/voice-journal/upload.ts
